...
const Page = () => {
  ...
  // Render loading state or the roadmap
  if (loading) {
    return <div className="text-center text-lg text-gray-600">Loading...</div>; // Loading state while fetching data
  }
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="flex flex-wrap justify-center relative">
        {roadmap.map((item, index) => (
          <div key={index} className="m-2 border rounded-lg p-4 bg-gray-50 shadow-md w-full sm:w-1/3 mb-4 relative">
            ...
            {/* Draw line and arrow for connecting cards */}
          </div>
        ))}
      </div>
    </div>
